  ...
  <main id="main">
      ...
      <div class="container" data-aos="fade-up">
        <div class="row gx-0">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="content">
              <h1>O que é CPaaS?</h1>
              <h2>Communications Plataform as a Service</h2>
              <em>Plataforma de Comunicação como Serviço</em>
    ...
    <section id="values" class="values">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>Por que Modavo?</h2>
          <p>
            Nossa plataforma conecta empresas e desenvolvedores em uma potente plataforma na nuvem, que
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
            <div class="box">
              ...
              <p>
                ...
                clientes do que faziam já apenas há 5 anos.
              </p>
            </div>
          </div>
    ...
    <section id="services" class="services">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          ...
          <p>Potencialize suas estratégias de comunicação com nossas soluções inovadoras</p>
        </div>
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-box blue">
              ...
              <p>Fortaleça a estratégia de segurança do seu negócio com autenticação de dois fatores
                avançada.</p>
              <a href="Produtos/twoFactor.html" class="read-more"><span>Saiba Mais</span> <i
    ...
    <section id="usos" class="usos">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>Como as empresas usam CPaaS?</h2>
          <p>Nossas soluções podem automatizar diversos setores da sua Empresa.</p>
        </div>
