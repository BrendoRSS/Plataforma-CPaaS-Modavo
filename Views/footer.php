  ...
  <div class="container">
    <div class="row gy-4">
      ...
      <div class="col-lg-2 col-6 footer-links">
        <h4>Navegue</h4>
        <ul>
          <li><i class="bi bi-chevron-right"></i> <a href="../index.php">CPaaS</a></li>
          <li><i class="bi bi-chevron-right"></i> <a href="sobre-nos.php">Sobre nós</a></li>
          <li><i class="bi bi-chevron-right"></i> <a href="../index.php">Serviços</a></li>
        </ul>
      </div>
